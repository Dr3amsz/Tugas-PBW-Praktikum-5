...
<body>
  <nav class="navbar navbar-expand-md fixed-top p-3">
    <div class="container-fluid px-md-5">
      <a class="navbar-brand fw-bold text-white" href="index.php">ZaxchTodo</a>
    ...
    <section class="container">
      <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 g-4 justify-content-center">
        <?php foreach($todos as $item):  ?>
          ...
          <?php if($item['deadline'] >= $todayStart && $item['deadline'] <= $todayEnd): ?>
          ...
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-footer d-flex justify-content-between">
                <button
                  ...
                  data-deadline="<?= date('d M Y', $item['deadline']) ?>"
                  data-priority="<?= ucfirst($item['priority']) ?>"
